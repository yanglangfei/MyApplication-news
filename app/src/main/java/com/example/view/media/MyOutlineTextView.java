...
public class MyOutlineTextView extends TextView
{
    public MyOutlineTextView(Context context)
    {
        super(context);
        initPaint();
    }

    public MyOutlineTextView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initPaint();
    }

    public MyOutlineTextView(Context context, AttributeSet attrs, int defStyle)
    {
