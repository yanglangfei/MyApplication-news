        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    ...
                    QkMediaPlayer mp = null;
                    if (mMediaPlayer == null)
                        break;
                    if (mMediaPlayer instanceof QkMediaPlayer) {
                        mp = (QkMediaPlayer) mMediaPlayer;
                        ...
                        if (internal != null && internal instanceof QkMediaPlayer)
                            mp = (QkMediaPlayer) internal;
                    }
                    if (mp == null)
                        break;
